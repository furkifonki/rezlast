-- Seçilen gün için en az bir müsait masası olan saatleri döner.
-- Mobil: supabase.rpc('get_available_slots_for_date', { p_business_id: '...', p_date: '2025-02-22', p_duration_minutes: 120 })
-- Bu günde hiç müsait saat yoksa boş dizi döner; uygulama "Bu günde uygun masa bulunamadı" gösterebilir.
...
BEGIN
  ...
  -- PostgreSQL DOW: 0=Sunday, 1=Monday, ..., 6=Saturday (JavaScript ile aynı; business_hours.day_of_week ile uyumlu)
...
COMMENT ON FUNCTION get_available_slots_for_date IS 'Mobil: Seçilen günde en az bir müsait masası olan saatleri (30 dk aralıklarla) döner. Boş = bu günde uygun masa yok.';
